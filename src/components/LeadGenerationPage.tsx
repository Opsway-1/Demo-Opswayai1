...
import { CheckCircle, Target, Zap, Users, TrendingUp, Mail, Database, Bot, ArrowRight, Play, Star, Clock, Shield, Filter, Search, UserCheck, Send } from 'lucide-react';
...
const LeadGenerationPage = () => {
  ...
  const benefits = [
    {
      ...
      description: "AI analyzes prospect data to craft personalized messages that resonate with each individual lead, dramatically increasing response rates."
    },
    {
  ...
  const leadProcessSteps = [
    {
      id: 1,
      title: "Discover Prospects",
      description: "Find companies that match your ideal customer profile",
      icon: <Search className="w-6 h-6" />,
      color: "from-blue-500 to-blue-600",
      stats: "Global reach",
      details: "Our AI searches across company websites, social media, industry databases, and news sources to identify businesses that fit your exact criteria and show buying signals."
    },
    {
      id: 2,
      title: "Smart Filtering",
      description: "Filter prospects by size, industry, and growth signals",
      icon: <Filter className="w-6 h-6" />,
      color: "from-purple-500 to-purple-600",
      stats: "Precision targeting",
      details: "Advanced algorithms analyze company size, industry, technology stack, recent funding, hiring patterns, and custom criteria to ensure every prospect matches your ideal customer profile."
    },
    {
      id: 3,
      title: "Qualify & Score",
      description: "Rank prospects by buying intent and decision authority",
      icon: <UserCheck className="w-6 h-6" />,
      color: "from-green-500 to-green-600",
      stats: "Quality focused",
      details: "Machine learning models evaluate buying intent signals, decision-making authority, budget indicators, and timing factors to prioritize the most promising prospects first."
    },
    {
      id: 4,
      title: "Personalized Outreach",
      description: "Send tailored messages that get responses",
      icon: <Send className="w-6 h-6" />,
      color: "from-[#FF6500] to-[#ff8533]",
      stats: "Higher engagement",
      details: "AI crafts personalized messages using prospect research, company news, and pain points, then sends at optimal times with intelligent follow-up sequences based on engagement."
    }
  ];
          ...
          <div className="pt-32 pb-20">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="text-center mb-16">
                ...
                {/* Lead Generation Process Visualization */}
                <motion.div 
                  ...
                  <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20 relative overflow-hidden">
                    ...
                    <div className="text-center mb-8">
                      <h3 className="text-2xl font-bold text-white mb-2 font-montserrat">
                        How We Find Your Perfect Clients
                      </h3>
                      <p className="text-white/80 font-montserrat">
                        Watch our AI system filter through prospects to find your ideal customers
                      </p>
                    </div>

                    {/* Process Steps */}
                    <div className="grid md:grid-cols-4 gap-6 mb-8">
                      {leadProcessSteps.map((step, index) => (
                        <motion.div
                          key={step.id}
                    ...
                    >
                      <div className="flex items-center space-x-4 mb-4">
                        <div className={`w-10 h-10 bg-gradient-to-r ${leadProcessSteps[activeStep].color} rounded-lg flex items-center justify-center text-white`}>
                          {leadProcessSteps[activeStep].icon}
                        </div>
                        <h4 className="text-xl font-bold text-white font-montserrat">
                          {leadProcessSteps[activeStep].title}
                        </h4>
                      </div>
                      <p className="text-white/90 font-montserrat leading-relaxed">
                        {leadProcessSteps[activeStep].details}
                      </p>
                    </motion.div>

                    {/* Progress indicators */}
                    <div className="flex justify-center mt-6 space-x-2">
                      {leadProcessSteps.map((_, index) => (
                        <button
                          key={index}
                          onClick={() => setActiveStep(index)}
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                <div className="relative bg-gradient-to-br from-[#0B192C] to-[#1a2b4a] rounded-3xl p-12 shadow-2xl overflow-hidden">
                  ...
                  <div className="relative z-10 space-y-8">
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          <div className="text-white/80 font-montserrat">Open Rate: Strong</div>
                          <div className="text-white/80 font-montserrat">Response Rate: High</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
                      ...
                      <div className="bg-white/10 rounded-lg p-4">
                        ...
                        <div className="text-white text-sm font-montserrat leading-relaxed">
                          "Hi John, I noticed TechCorp recently expanded to the West Coast. Our AI automation helped similar companies reduce operational costs during expansion..."
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-green-400 text-sm font-montserrat">Performance Improving</div>
                    </div>
                  </div>
                ...
                {/* Floating stats around illustration - removed the 67% Open Rate box */}
                ...
                <div className="absolute -bottom-4 -left-4 bg-white rounded-2xl p-4 shadow-xl border border-gray-100">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      <div className="text-[#0B192C] font-bold text-sm font-montserrat">High</div>
                      <div className="text-gray-600 text-xs font-montserrat">Response Rate</div>
                    </div>
                  </div>
                </div>
              </motion.div>
